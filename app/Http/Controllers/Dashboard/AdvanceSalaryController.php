...
class AdvanceSalaryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($advanced->isEmpty()) {
            ...
            return Redirect::route('advance-salary.create')->with('success', '¡Adelanto de salario pagado con éxito!');
        } else {
    ...
    public function update(Request $request, AdvanceSalary $advanceSalary)
    {
        ...
        if (!$advanced && $newYm == $oldYm) {
            ...
            return Redirect::route('advance-salary.edit', $advanceSalary->id)->with('success', '¡Adelanto de salario actualizado exitosamente!');
        } else {
    ...
    public function destroy(AdvanceSalary $advanceSalary)
    {
        ...
        return Redirect::route('advance-salary.index')->with('success', '¡Se ha eliminado el adelanto de sueldo!');
    }
}
