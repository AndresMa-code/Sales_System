...
class PaySalaryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return Redirect::route('pay-salary.payHistory')->with('success', '¡Salario de empleado pagado exitosamente!');
    }
    ...
    public function destroy(PaySalary $paySalary)
    {
        ...
        return Redirect::route('pay-salary.payHistory')->with('success', '¡El historial de pago del empleado(a) ha sido eliminado!');
    }
}
