...
class EmployeeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return Redirect::route('employees.index')->with('success', '¡Se ha creado el empleado!');
    }
    ...
    public function destroy(Employee $employee)
    {
        ...
        return Redirect::route('employees.index')->with('success', '¡El empleado(a) ha sido eliminado!');
    }
}
