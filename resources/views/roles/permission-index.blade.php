        ...
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="mb-0">Un panel de permisos le permite recopilar y visualizar fácilmente los datos de permisos para optimizarlos. <br>
                        La experiencia de permisos garantiza su retención. </p>
                </div>
                <div>
                    <a href="{{ route('permission.create') }}" class="btn add-list"
                                        style="color: white; border: 2px solid #007BFF; background-color: #007BFF; transition: background-color 0.3s;"><i
                            class="fa-solid fa-plus mr-3"></i>Agregar permiso</a>
                </div>
            </div>
        </div>
