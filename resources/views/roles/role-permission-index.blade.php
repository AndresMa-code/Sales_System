    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                ...
                <div>
                    <a href="{{ route('rolePermission.create') }}" class="btn add-list"
                                        style="color: white; border: 2px solid #007BFF; background-color: #007BFF; transition: background-color 0.3s;"><i
                            class="fa-solid fa-plus mr-3"></i>Agregar rol en el permiso</a>
                </div>
            </div>
        </div>
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="badge rounded-pill" style="background-color: #ffb300;">
                                    {{ $permission->name }}
                                </span>
                                @endforeach
                            </td>
