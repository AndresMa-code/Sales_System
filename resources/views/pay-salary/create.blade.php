                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="id" value="{{ $advanceSalary->id }}">
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="due_salary">Salario debido <span class="text-danger">*</span></label>
                        ...
                        <!-- end: Input Data -->
                        <div class="mt-2">
                            <button type="submit" class="btn" style="background-color: #007BFF; color: white;"><i class="fas fa-money-check-alt mr-2"></i>Salario pagado</button>
                        </div>
                    </form>
                </div>
            </div>
