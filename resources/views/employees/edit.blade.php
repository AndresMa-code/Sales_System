                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="city">Ciudad de los empleados <span class="text-danger">*</span></label>
                        ...
                        <div class="mt-2">
                            ...
                            <a class="btn" href="{{ route('employees.index') }}" style="background-color: #ff6f6f; color: white;">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
