                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="mb-2">Diseñador de interfaz</br>de usuario / UX</p>
                            <a href="{{ route('employees.edit', $employee->id) }}"
                                style="background-color: #28a745; color: white;"
                                class="btn font-size-14">Editar</a>
                            <a href="{{ route('employees.index') }}"
                            style="background-color: #ff6f6f; color: white;"
                            class="btn font-size-14">Atrás</a>
                        </div>
                    </div>
                    ...
                    <ul class="list-inline p-0 mb-0">
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $employee->name }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $employee->email }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $employee->phone }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $employee->experience }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="${{ $employee->salary }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $employee->vacation }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
                        <li class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 col-8">
                                    <input type="text" class="form-control bg-white" value="{{ $employee->city }}"
                                        readonly>
                                </div>
                            </div>
                        </li>
