                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div class="ml-3">
                            ...
                            <a href="{{ route('customers.edit', $customer->id) }}" style="background-color: #28a745; color: white;"
                                class="btn font-size-14">Editar</a>
                            <a href="{{ route('customers.index') }}" style="background-color: #ff6f6f; color: white;"
