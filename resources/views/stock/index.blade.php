    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                <div>
                    <h4 class="mb-3">Lista de productos en existencia (stock)</h4>
                    <p class="mb-0">Un panel de control de existencias le permite recopilar y visualizar fácilmente
                        información sobre los productos disponibles, <br>
                        facilita una gestión eficiente del inventario. Esto optimiza la experiencia de inventario y
                        garantiza una retención adecuada. </p>
                </div>
            </div>
        </div>
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    ...
                                    <a href="{{ route('order.stockManage') }}" class="input-group-text text-white" style="background-color: #ff6f6f;">
                ...
                <table class="table mb-0">
                    ...
                    <tbody class="ligth-body">
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="btn text-white mr-2"
                                    style="background-color: #1fb8cc; border: 2px solid #1fb8cc;">
