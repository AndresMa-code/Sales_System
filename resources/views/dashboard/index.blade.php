        ...
        <div class="col-lg-4">
            <div class="card card-transparent card-block card-stretch card-height border-none">
                <div class="card-body p-0 mt-lg-2 mt-0">
                    <h3 class="mb-3">Hola {{ auth()->user()->name }}, ¡Bienvenido al sistema: Sales System</h3>
                    <p class="mb-0 mr-4">El panel de control Dashboard, donde podrás gestionar de forma fácil y eficiente tanto tus compras como ventas de productos.</p>
                </div>
            </div>
        </div>
        <div class="col-lg-8">
                    ...
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4 card-total-sale">
                                ...
                                <div>
                                    <p class="mb-2">Compras totales</p>
                                    <h4>$ {{ $total_paid }}</h4>
                                </div>
                            </div>
                            <div class="iq-progress-bar mt-2">
                                <span class="iq-progress progress-1" data-percent="85" style="background-color: #007BFF; color: white;">
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-block card-stretch card-height">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-4 card-total-sale">
                                ...
                                <div>
                                    <p class="mb-2">Compra completa</p>
                    ...
                    <div class="card-header-toolbar d-flex align-items-center">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow-none"
                                ...
                                <a class="dropdown-item" href="#">Semanalmente</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="card card-transparent card-block card-stretch mb-4">
                <div class="card-header d-flex align-items-center justify-content-between p-0">
                    <div class="header-title">
                        <h4 class="card-title mb-0">Noticias de productos</h4>
                    </div>
                    <div class="card-header-toolbar d-flex align-items-center">
                        <div>
                            <a href="#" class="btn font-size-14" style="background-color: #007BFF; color: white;">
                                Ver todo
                            </a>
                        </div>
                    </div>
                ...
                <div class="card-body card-item-right">
                    <div class="d-flex align-items-top">
                        ...
                        <div class="style-text text-left">
                            ...
                            <p class="mb-2">Existencias : {{ $product->product_store ?? $product->stock ?? $product->quantity ?? 0 }}</p>
...
<!-- Pass the value from php to js before chart-custom.js -->
<script>window.totalPaid = {{ $total_paid ?? 0 }};</script>
<!-- Chart Custom JavaScript -->
