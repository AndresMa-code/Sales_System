<div class="iq-top-navbar">
    <div class="iq-navbar-custom">
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between" style="height: 40px;">
                <i class="ri-menu-line wrapper-menu" style="font-size: 24px;"></i>
                <a href="{{ route('dashboard') }}" class="header-logo d-flex align-items-center">
                    <img src="{{ asset('assets/images/images.pos.png') }}" alt="logo" style="height: 40px;">
                    <h5 class="logo-title ml-3" style="color: #140e83; font-size: 18px; margin: 0;">Sales System</h5>
                </a>
            </div>
            
                <div class="iq-search-bar device-search">
                    <div class="search-blocked-message">
                </div>
            </div>
                                        ...
                                        <div class="p-3">
                                            ...
                                            <div class="d-flex align-items-center justify-content-center mt-3">
                                                ...
                                                <form action="{{ route('logout') }}" method="POST">
                                                    @csrf
                                                    <button type="submit" class="btn border">Desconectar</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
