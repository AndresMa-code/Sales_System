...
<div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Editar Salario Adelantado</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                <label for="advance_salary">Salario adelantado <span class="text-danger">*</span></label>
                        ...
                        <div class="mt-2">
                            ...
                            <a class="btn" href="{{ route('advance-salary.index') }}" style="background-color: #ff6f6f; color: white;">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    @if (session('success'))
        <script>
            // Automatically redirect after successful saving
            window.location.href = "{{ route('advance-salary.index') }}";
        </script>
    @endif
</div>
