            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Editar la asistencia de los empleados</h4>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    @csrf
                        ...
                        <div class="mt-2">
                            ...
                            <a href="{{ route('attendence.index') }}" class="btn" style="background-color: #ff6f6f; color: white;">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
