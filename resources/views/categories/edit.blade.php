                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-12">
                                <label for="slug">Identificador de categoría <span class="text-danger">*</span></label>
                        ...
                        <div class="mt-2">
                            ...
                            <a class="btn" href="{{ route('categories.index') }}" style="background-color: #ff6f6f; color: white;">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
